 ...
 * @category    Mage
 * @package     Mage_Sales
 * @author      Magento Core Team <core@magentocommerce.com>Manohar_Modelrewrite_Model_Sales_Order_Invoice_Item
 */
class Manohar_Modelrewrite_Model_Sales_Order_Invoice_Item extends Mage_Sales_Model_Order_Invoice_Item
{
